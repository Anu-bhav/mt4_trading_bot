...
STRATEGY_SYMBOL = "SPY"  # The symbol to trade, e.g., BTCUSD, EURUSD, etc.
STRATEGY_TIMEFRAME = "M1"

STRATEGY_NAME = "alpha_vortex_strategy"  # Options: sma_crossover, rsi_strategy, tick_counter_strategy, etc.
